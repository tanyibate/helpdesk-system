...
<body>
  ...
  <strong>Success!</strong> Call has been logged
</div>									
				</div>
...
function myF() {
	...
	change = true;
		...
		change = false;
							...
							<label>Specialist:</label><input type="text" name = "specialist" id="specialist" onchange="" style="margin-top: 10px" value ="<?php echo $specialistI; ?>"  >&nbsp;  &nbsp;<button type="button" onclick="myF();">View Specialists</button>
