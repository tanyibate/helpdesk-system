<!-- Main page for technical specialist Donnovan displaying her pending problems and log out button
It uses an sql query searching for problems assigned to Donnovan where Date of Solution has not been logged
This means it is unresolved
Contribution: Roberto Trujillo -->
<html !DOCTYPE>
<head>
	<meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Donnovan</title>
    <!-- Bootstrap CSS CDN -->
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<br><br>
				...
				$sql = "SELECT Problem_ID, Problem_Type, Sub_Problem, Date_Of_Report, Time_Of_Report, Problem_Details  FROM Problem_Table WHERE Specialist_Allocated LIKE 'Donnovan Mitchell' && Date_Of_Solution IS NULL ";
