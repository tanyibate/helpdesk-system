	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<br><br>
				...
				$sql = "SELECT Problem_ID, Problem_Type, Sub_Problem, Date_Of_Report, Time_Of_Report, Problem_Details  FROM Problem_Table WHERE Specialist_Allocated LIKE 'Bert Adams' && Date_Of_Solution IS NULL ";
