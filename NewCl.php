 ...
 while($row = $result->fetch_assoc())
 {
  ...
  $output .= '
   <tr>
	...
	<td><a href="newcall.php?chosenspecialist='.$selectedspecialist.'">Select</a></td>
	...
	<div class="wrapper">
     ...
     <div class="col-sm-6">
			<h1 >New Call</h1>
					...
					<form action="newcallcallsubmit.php" method="post">
						...
						<div class="button">
							<button type="submit" data-toggle="modal">Log Call</button> 
						</div>
			...
			<h1>New Problem</h1>
					...
					<form action="newcallproblemsubmit.php" method="post">
						...
						<div class="inputs">
							...
							<label>Problem:</label> <select name = "type" id="problem" onchange="subProblem();chooseSpecialist(this.value)" style="margin-top: 10px">
...
function myF() {
	...
	change = true;
		...
		change = false;
							...
							<label>Specialist:</label><input type="text" name = "specialist" id="specialist" onchange="" style="margin-top: 10px" value ="<?php echo $specialistI; ?>" readonly >&nbsp;  &nbsp;<button type="button" onclick="myF();">Manually Select</button>
...
function validateForm() {
    var x = document.forms["reason"].value;
    if (x == "") {
        alert("Please write a reason for the call.");
        return false;
    }
}
