<!-- Main page for technical specialist Carl displaying her pending problems and log out button
It uses an sql query searching for problems assigned to Carl where Date of Solution has not been logged
	...
	<div class="wrapper">
		...
		<div id="content">
			...
			<br><br>
				...
				$sql = "SELECT Problem_ID, Problem_Type, Sub_Problem, Date_Of_Report, Time_Of_Report, Problem_Details  FROM Problem_Table WHERE Specialist_Allocated LIKE 'Carl Jones' && Date_Of_Solution IS NULL ";
